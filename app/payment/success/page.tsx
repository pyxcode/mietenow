...
export default function PaymentSuccess() {
  ...
  const translations = {
    ...
    en: {
      ...
      sarahQuote: 'I was skeptical at first, but mietenow really worked. After 3 weeks I had my apartment in Prenzlauer Berg.',
      anna: 'Anna K.',
      annaRole: 'Chef, Restaurant Amarone',
      annaQuote: 'As a chef I work irregular hours. mietenow helped me find the best deals even at night.',
      thomas: 'Thomas R.',
      thomasRole: 'Business Development',
      thomasQuote: 'I had almost given up finding an affordable apartment in Berlin. Then mietenow came along and everything became easier.',
      maria: 'Maria S.',
      mariaRole: 'Designer, Startup',
      mariaQuote: 'The time savings are enormous. Instead of searching for hours on different sites, I get everything in one app.',
      david: 'David L.',
      davidRole: 'Engineer, Tech Company',
      davidQuote: 'Finally a solution that really works. I found my apartment in Kreuzberg, exactly as I had imagined.',
      lisa: 'Lisa W.',
      lisaRole: 'Marketing Manager',
      lisaQuote: 'I was surprised how fast it went. Within 2 weeks I had several viewing appointments and could choose.',
      friedrich: 'Friedrich W.',
      friedrichRole: 'Marketing Manager',
      friedrichQuote: 'I was surprised how fast it went. Within 2 weeks I had several viewing appointments and could choose.'
    }
  }

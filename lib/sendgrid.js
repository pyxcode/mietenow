...
function generateAlertEmailHTML(listings, userPreferences) {
...
function generateUnpaidUserEmailHTML(listings, userPreferences) {
  const { address, radius } = userPreferences
...
module.exports = { sendEmail, generateAlertEmailHTML, generateUnpaidUserEmailHTML }
